		...
		try{
			...
			while( (s=in.readLine()) != null ){
				...
				for(String sd : seed){
					...
					if(enable_tree)
						insertDispTree(node , newnode , value) ;
...
*/
	public void insertDispTree(String par , String s , int value){
		Position p = null ;
		// retri from pos hash
		if(par.equals("root")){
			p = tree.root() ;
		...
		Position newp = tree.insertLastChild(p , s+" "+value) ;
...
*/
	...
	public void printBitMap(){
		System.out.println(cluster + " " + powk + " " + maxTransSize) ;
		Set s ;
		s = hash.keySet() ;
